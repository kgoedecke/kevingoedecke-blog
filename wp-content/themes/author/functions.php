...
function ct_author_social_array(){
	...
	$social_sites = array(
		...
		'stack-overflow' => 'author_stack-overflow_profile',
                    ...
                    <li>
                        <a class="email" target="_blank" href="mailto:<?php echo antispambot( is_email( ct_author_get_social_url( $source, $key ) ) ); ?>">
                            <span class="fa-stack fa-lg">
                            	...
                            	<i class="fa fa-envelope fa-stack-1x" title="<?php _e('email icon', 'author'); ?>"></i>
                            </span>
                        </a>
                    </li>
                ...
                <?php } else { ?>
                    <li>
                        <a class="<?php echo $active_site; ?>" target="_blank" href="<?php echo esc_url( ct_author_get_social_url( $source, $key ) ); ?>">
                            <span class="fa-stack fa-lg">
                            	<i class="fa fa-circle fa-stack-2x fa-inverse"></i>
                            	<i class="fa fa-<?php echo esc_attr( $active_site ); ?> fa-stack-1x" title="<?php printf( __('%s icon', 'author'), $active_site ); ?>"></i>
                        	</span>
                        </a>
                    </li>
                <?php
